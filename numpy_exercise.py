...
print("Max sale: ", salesArray.max(), "\nMin sale: ", salesArray.min())
...
sales_fees = salesArray.copy() * 0.02
print(sales_fees)
new_sales = sales_fees + salesArray.copy()
print(new_sales)
...
salesArray += salesArray + newRegister
print(salesArray)
